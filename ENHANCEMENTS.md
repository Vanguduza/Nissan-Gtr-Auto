...
| H4 | B-MONEY-1 dual-read | Done (cutover habit) | API prefer `amountMinor`; physical NUMERIC drop deferred; see `docs/plans/2026-08-13-h4-money-dual-read-cutover.md` |
