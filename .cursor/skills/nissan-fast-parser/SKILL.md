---
name: nissan-fast-parser
description: Nissan FAST EPC parsing — VIN decode, PNC/OEM mapping, vehicle hierarchy for the data pipeline. Use when the task touches FAST EPC data, VIN decoding, PNC codes, or data-pipeline Nissan ingestion.
---
...
5-digit codes identifying sub-assemblies. Store in `pnc_categories`: `pnc_code`, `category_name`, `subcategory_name`.
...
4. Batch import into `vehicle_master`, `pnc_categories`, `part_fitment`.
