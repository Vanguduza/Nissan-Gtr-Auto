...
description: Double-entry ledger, Chart of Accounts, journal entries, and financial statements for Nissan GTR Auto ERP. Use when the task touches ledger schema, journal entries, Chart of Accounts, financial statements, or the finance module.
---
